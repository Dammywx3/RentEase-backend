...
DB="${DB:-rentease}"
SQL_FILE="sql/2026_01_18_fix_get_or_create_user_wallet_account_ambiguity.sql"
mkdir -p sql
...
echo
echo "✅ Fixed ambiguity. Verify signatures now:"
echo "DB=rentease psql -X -P pager=off -d \"$DB\" -c \"\\df+ public.get_or_create_user_wallet_account\""
