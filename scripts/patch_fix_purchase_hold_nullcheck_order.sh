cat > scripts/patch_prettify_purchase_hold_spacing.sh <<'BASH'
#!/usr/bin/env bash
set -euo pipefail
...
chmod +x scripts/patch_prettify_purchase_hold_spacing.sh
bash scripts/patch_prettify_purchase_hold_spacing.sh