...
-- Patch trigger function: dedupe status_changed when status only changed due to payment_status autosync
...
-- Show trigger still points to this function (no pager)
